...
public class CustomCrop {
    ...
    public enum CropType {
        TOMATO(false, 1, 2, org.bukkit.Material.OAK_FENCE), // 2 стадии (0 и 1)
        GLOWSHROOM(false, 1, 2, org.bukkit.Material.BIRCH_FENCE), // 2 стадии
        STRAWBERRY(true, 3, 2, org.bukkit.Material.JUNGLE_FENCE), // 2 стадии
        RADISH(false, 1, 2, org.bukkit.Material.OAK_FENCE),
        WATERMELON(true, 2, 2, org.bukkit.Material.MELON),
        LUNAR_BERRY(true, 3, 3, org.bukkit.Material.END_ROD), // 3 стадии
        RAINBOW_MUSHROOM(false, 1, 2, org.bukkit.Material.WARPED_FENCE),
        CRYSTAL_CACTUS(true, 2, 3, org.bukkit.Material.CACTUS),
        FLAME_PEPPER(false, 1, 2, org.bukkit.Material.NETHER_BRICK_FENCE),
        MYSTIC_ROOT(true, 2, 3, org.bukkit.Material.WARPED_FENCE),
        STAR_FRUIT(true, 2, 2, org.bukkit.Material.BAMBOO),
        PREDATOR_FLOWER(false, 1, 3, org.bukkit.Material.DARK_OAK_FENCE),
        ELECTRO_PUMPKIN(true, 2, 2, org.bukkit.Material.LIGHTNING_ROD),
        MANDRAKE_LEAF(false, 1, 2, org.bukkit.Material.AZALEA_LEAVES),
        FLYING_FRUIT(true, 2, 2, org.bukkit.Material.BIRCH_FENCE),
        SNOW_MINT(false, 1, 2, org.bukkit.Material.SNOW_BLOCK),
        SUN_PINEAPPLE(true, 2, 3, org.bukkit.Material.BAMBOO),
        FOG_BERRY(false, 1, 2, org.bukkit.Material.COBWEB),
        SAND_MELON(true, 2, 2, org.bukkit.Material.SANDSTONE),
        WITCH_MUSHROOM(false, 1, 2, org.bukkit.Material.MANGROVE_FENCE);
        ...
        CropType(boolean multiHarvest, int defaultHarvests, int maxStages, org.bukkit.Material stemMaterial) {
